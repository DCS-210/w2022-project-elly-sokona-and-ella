...
knitr::opts_chunk$set(fig.retina = 3, dpi = 300, fig.width = 6, fig.asp = 0.618, out.width = "100%", warning = FALSE, echo = FALSE)
```
...
---
# Leaflets
```{r chicago spatial data, include = FALSE, message = FALSE, warningn = FALSE}
...
```{r White-perc-leaflet, include = TRUE}
 White_perc_m <- m %>%
   addPolygons(
     fillOpacity = 1,
     color = "black",
