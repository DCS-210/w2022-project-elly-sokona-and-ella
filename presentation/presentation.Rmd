...
```{r complaints-perc-leaflet, fig.width = 10, out.width = "150%", fig.alt = "Leaflet MapShowing the complaints per capita. Highest number of complaints per capita are in neighborhoods that are majority Black, and one majority white neighboborhood", message = FALSE, echo = FALSE, warning = FALSE, error = FALSE}
...
```{r complaints-for-sustained-decisions, message = FALSE, echo = FALSE, warning = FALSE, error = FALSE}
...
```{r complaints-noaffidavit-decisions, message = FALSE, echo = FALSE, warning = FALSE, error = FALSE}
...
```{r missing-complaint-data, message = FALSE, echo = FALSE, warning = FALSE, error = FALSE}
