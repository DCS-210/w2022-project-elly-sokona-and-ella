...
```{r complaints-perc-leaflet, out.width = "70%", fig.alt = "Leaflet Map Showing the complaints per capita. Highest number of complaints per capita are in neighborhoods that are majority Black, and one majority white neighboborhood", message = FALSE, echo = FALSE, warning = FALSE, error = FALSE}
...
```{r r proportion-findings-vis, message = FALSE, echo = FALSE, warning = FALSE, error = FALSE, out.width = "70%"}
  data1 %>%   
  filter(is.na(District_Name) == FALSE) %>%
